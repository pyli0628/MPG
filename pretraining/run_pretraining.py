...
from model import Pretrain_MolGNet
...
def create_pretraining_dataset(input_file,  args, worker_init):
    train_data = PretrainDataset("data/" + args.dataset, rank = input_file)
...
def parse_arguments():
    ...
    parser.add_argument('--dataset', type=str, default='pretraining',
